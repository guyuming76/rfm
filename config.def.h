...
static RFM_MenuItem run_actions[] = {
   /* name           mime root        mime sub type            filenameSuffix           OrSearchResultType	runCmd            		showCondition	*/
   { RunActionCopy,  "*",              "*",                    NULL,			NULL,			f_cp,             		NULL },
   { RunActionMove,  "*",              "*",                    NULL,			NULL,			f_mv,             		NULL },
   { RunActionDelete, "*",             "*",                    NULL,			NULL,			f_rm,             		NULL },
   { RunActionSL,    "*",              "*",                    NULL,			NULL,			create_softlink,                NULL },
   { RunActionFindSL,"*",              "*",                    NULL,			NULL,			find_softlink,                  NULL },
#ifdef GitIntegration
   { RunActionGitStage,  "*",          "*",                    NULL,			NULL,			git_stage_cmd,    		cur_path_is_git_repo },
   { "git log",      "*",              "*",                    NULL,			NULL,			git_log_cmd,      		cur_path_is_git_repo },
// { "tig",          "*",              "*",                    NULL,			NULL,			tig_cmd,          		cur_path_is_git_repo },
#endif
   { "Properties",   "*",              "*",                    NULL,			NULL,			properties,       		NULL },
   { "Open with...", "*",              "*",                    NULL,			NULL,			open_with,        		NULL },
   { RunActionChangeOwner,"*",         "*",                    NULL,			NULL,			change_owner,                   NULL },
   { "Open",         "message",        "rfc822",               NULL,			"muview",               muview,                         NULL },
   { "Open",         "image",          "*",                    NULL,			NULL,			show_image,       		NULL },
   { "Open",         "application",    "vnd.oasis.opendocument.text",          NULL,	NULL,			soffice,  			NULL },
   { "Open",         "application",    "vnd.oasis.opendocument.spreadsheet",   NULL,	NULL,			soffice,  			NULL },
   { "Open",         "application",    "vnd.openxmlformats-officedocument.wordprocessingml.document",NULL, NULL,soffice,  			NULL },
   { "Open",         "application",    "vnd.openxmlformats-officedocument.spreadsheetml.sheet",NULL,       NULL,soffice,  			NULL },
   { "Open",         "application",    "msword",               NULL,			NULL,			soffice,          		NULL },
   { "Open",         "application",    "x-gnumeric",           NULL,			NULL,			gnumeric,         		NULL },
   { "Open",         "application",    "vnd.ms-excel",         NULL,			NULL,			gnumeric,         		NULL },
   { "Open",         "application",    "vnd.ms-excel",         NULL,			NULL,			soffice,          		NULL },
   { "view archive", "application",    "x-compressed-tar",     NULL,			NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-bzip-compressed-tar",NULL,			NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-xz-compressed-tar",  NULL,			NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-zstd-compressed-tar",NULL,			NULL,			list_archive,                   NULL },
   { "view archive", "application",    "zip",                  NULL,			NULL,			list_archive,                   NULL },
   {RunActionRefreshThumb,"application","zip",                 ".ggb",			NULL,			geogebraThumb,                  NULL },
   { "view archive", "application",    "x-rpm",                NULL,			NULL,			list_archive,                   NULL },
   { "extract",      "application",    "x-compressed-tar",     NULL,			NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-bzip-compressed-tar",NULL,			NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-xz-compressed-tar",  NULL,			NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-zstd-compressed-tar",NULL,			NULL,			extract_archive, 		NULL },
   { "extract",      "application",    "zip",                  NULL,			NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-rpm",                NULL,			NULL,			extract_archive,  		NULL },
   { "View",         "application",    "pdf",                  NULL,			NULL,			pdf,             		NULL },
   { "View",         "application",    "epub+zip",             NULL,			NULL,			mupdf,            		NULL },
   { "View",         "application",    "x-troff-man",          NULL,			NULL,			man,              		NULL },
   { "Run",          "application",    "x-java-archive",       NULL,			NULL,			java,             		NULL },
   { "Open as text", "application",    "*",                    NULL,			NULL,			textEdit,         		NULL },
   { "Play",         "audio",          "*",                    NULL,			NULL,			play_audio,       		NULL },
   { "flac info",    "audio",          "flac",                 NULL,			NULL,			metaflac,         		NULL },
   { "info",         "audio",          "*",                    NULL,			NULL,			av_info,          		NULL },
   { "stats",        "audio",          "*",                    NULL,			NULL,			audioSpect,       		NULL },
   { "count",        "inode",          "directory",            NULL,			NULL,			du,               		NULL },
   { "archive",      "inode",          "directory",            NULL,			NULL,			create_archive,   		NULL },
   { "mount",        "inode",          "mount-point",          NULL,			NULL,			mount,            		NULL },
   { "unmount",      "inode",          "mount-point",          NULL,			NULL,			umount,           		NULL },
   { "mount",        "inode",          "blockdevice",          NULL,			NULL,			mount,            		NULL },
   { "unmount",      "inode",          "blockdevice",          NULL,			NULL,			umount,           		NULL },
   { "edit",         "text",           "*",                    NULL,			NULL,			textEdit,         		NULL },
   { "Open",         "text",           "html",                 NULL,			NULL,			www,              		NULL },
   { "Play",         "video",          "*",                    NULL,			NULL,			play_video,       		NULL },
   { "info",         "video",          "*",                    NULL,			NULL,			av_info,          		NULL },
   { "View",         "font",           "*",                    NULL,			NULL,			ftview,           		NULL },
};
