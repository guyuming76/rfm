...
static RFM_MenuItem run_actions[] = {
   /* name           mime root        mime sub type            OrSearchResultType	runCmd            		showCondition	*/
   { RunActionCopy,  "*",              "*",                    NULL,			f_cp,             		NULL },
   { RunActionMove,  "*",              "*",                    NULL,			f_mv,             		NULL },
   { RunActionDelete, "*",             "*",                    NULL,			f_rm,             		NULL },
   { RunActionSL,    "*",              "*",                    NULL,			create_softlink,                NULL },
   { RunActionFindSL,"*",              "*",                    NULL,			find_softlink,                  NULL },
#ifdef GitIntegration
   { RunActionGitStage,  "*",          "*",                    NULL,			git_stage_cmd,    		cur_path_is_git_repo },
   { "git log",      "*",              "*",                    NULL,			git_log_cmd,      		cur_path_is_git_repo },
// { "tig",          "*",              "*",                    NULL,			tig_cmd,          		cur_path_is_git_repo },
#endif
   { "Properties",   "*",              "*",                    NULL,			properties,       		NULL },
   { "Open with...", "*",              "*",                    NULL,			open_with,        		NULL },
   { RunActionChangeOwner,"*",         "*",                    NULL,			change_owner,                   NULL },
   { "Open",         "message",        "rfc822",               "muview",                muview,                         NULL },
   { "Open",         "image",          "*",                    NULL,			show_image,       		NULL },
   { "Open",         "application",    "vnd.oasis.opendocument.text",          NULL,			soffice,  	NULL },
   { "Open",         "application",    "vnd.oasis.opendocument.spreadsheet",   NULL,			soffice,  	NULL },
   { "Open",         "application",    "vnd.openxmlformats-officedocument.wordprocessingml.document", NULL,   soffice,  NULL },
   { "Open",         "application",    "vnd.openxmlformats-officedocument.spreadsheetml.sheet",       NULL,   soffice,  NULL },
   { "Open",         "application",    "msword",               NULL,			soffice,          		NULL },
   { "Open",         "application",    "x-gnumeric",           NULL,			gnumeric,         		NULL },
   { "Open",         "application",    "vnd.ms-excel",         NULL,			gnumeric,         		NULL },
   { "Open",         "application",    "vnd.ms-excel",         NULL,			soffice,          		NULL },
   { "view archive", "application",    "x-compressed-tar",     NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-bzip-compressed-tar",NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-xz-compressed-tar",  NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-zstd-compressed-tar",NULL,			list_archive,                   NULL },
   { "view archive", "application",    "zip",                  NULL,			list_archive,                   NULL },
   { "view archive", "application",    "x-rpm",                NULL,			list_archive,                   NULL },
   { "extract",      "application",    "x-compressed-tar",     NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-bzip-compressed-tar",NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-xz-compressed-tar",  NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-zstd-compressed-tar",NULL,			extract_archive, 		NULL },
   { "extract",      "application",    "zip",                  NULL,			extract_archive,  		NULL },
   { "extract",      "application",    "x-rpm",                NULL,			extract_archive,  		NULL },
   { "View",         "application",    "pdf",                  NULL,			pdf,             		NULL },
   { "View",         "application",    "epub+zip",             NULL,			mupdf,            		NULL },
   { "View",         "application",    "x-troff-man",          NULL,			man,              		NULL },
   { "Run",          "application",    "x-java-archive",       NULL,			java,             		NULL },
   { "Open as text", "application",    "*",                    NULL,			textEdit,         		NULL },
   { "Play",         "audio",          "*",                    NULL,			play_audio,       		NULL },
   { "flac info",    "audio",          "flac",                 NULL,			metaflac,         		NULL },
   { "info",         "audio",          "*",                    NULL,			av_info,          		NULL },
   { "stats",        "audio",          "*",                    NULL,			audioSpect,       		NULL },
   { "count",        "inode",          "directory",            NULL,			du,               		NULL },
   { "archive",      "inode",          "directory",            NULL,			create_archive,   		NULL },
   { "mount",        "inode",          "mount-point",          NULL,			mount,            		NULL },
   { "unmount",      "inode",          "mount-point",          NULL,			umount,           		NULL },
   { "mount",        "inode",          "blockdevice",          NULL,			mount,            		NULL },
   { "unmount",      "inode",          "blockdevice",          NULL,			umount,           		NULL },
   { "edit",         "text",           "*",                    NULL,			textEdit,         		NULL },
   { "Open",         "text",           "html",                 NULL,			www,              		NULL },
   { "Play",         "video",          "*",                    NULL,			play_video,       		NULL },
   { "info",         "video",          "*",                    NULL,			av_info,          		NULL },
   { "View",         "font",           "*",                    NULL,			ftview,           		NULL },
};
